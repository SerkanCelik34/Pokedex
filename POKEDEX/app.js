const searchİnput = document.querySelector("#poke-input")
...
const createPokemonBox = (pokemon) =>{
    ...
    console.log(name,id,weight,type,color)
...
searchİnput.addEventListener("input",function(e){
    const pokeNames=document.querySelectorAll(".poke-name");
    const search=searchİnput.value.toLowerCase();
